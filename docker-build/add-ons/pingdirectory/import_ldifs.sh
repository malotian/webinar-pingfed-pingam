...
/opt/pingdirectory/bin/ldapmodify --defaultAdd -h localhost -p 389 -D "cn=administrator" -w password -f /opt/tmp/group.ldif
/opt/pingdirectory/bin/ldapmodify -h localhost -p 389 -D "cn=administrator" -w password \
